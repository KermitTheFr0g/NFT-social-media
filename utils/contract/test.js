...
const instantiateContract = (baseContractPath) => {
  ...
  const contractFile = tempFile.contracts[baseContractPath]['GunKillers'];
  // exports the abi 
  fs.writeFileSync('../../user_contracts_abi/contract_abi.json', JSON.stringify(contractFile.abi));
...
const newContract = instantiateContract('../../user_contracts/contract_0x516923E55e9eD4Bcf08CFA4A477a11805b0CD72C.sol');
