...
contract yamom is ERC721, ERC721URIStorage, Ownable {
    ...
    function publicMint(
        ...
        require(mintedWallets[msg.sender] + amount <= 21, "You cannot mint more than 21!");
        require(totalSupply + amount <= maxSupply, "Max NFTS have been reached");
        require(msg.value == 420.69 ether, "This NFT costs 420.69 ETH");
